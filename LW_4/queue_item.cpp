...
QueueItem<First, Second, Third>::QueueItem(const std::shared_ptr<First> &first_figure, const std::shared_ptr<Second> &second_figure, const std::shared_ptr<Third> &third_figure, const std::shared_ptr<QueueItem> &node)
{
	first = first_figure;
